...
for(i in 1:790){
  ...
  type <- html_nodes(web,"#root > div > div:nth-child(6) > div:nth-child(2) > div._2Zo7I > div._3lkcG._28MZZ > div > div > div:nth-child(6) > div:nth-child(2)") %>% html_text

  print(type)
  t <- enc2utf8(type)
  ID_ISIN<-data.frame(t)
  ID_ISIN_ALL<-rbind(ID_ISIN_ALL,ID_ISIN)
  

  write.csv(ID_ISIN_ALL,file="C:/Users/qiuch/Desktop/file/type.csv",row.names = FALSE)
  #}
